...
npn5GNWIdentity_IRI="https://example.com/ids/sm/6324_6140_9032_3623"
assetServiceRegistry_IRI="https://example.com/ids/sm/2254_6150_9032_5216"
tsnCapabilities_IRI="https://example.com/ids/sm/9200_7150_9032_5023"
network5GDataSheet_IRI="https://example.com/ids/sm/6042_5122_3042_7804"
virtualsNetwork_IRI="https://example.com/ids/sm/8131_6122_3042_7812"
connectivity_IRI="https://example.com/ids/sm/5280_1152_3042_0914"
qosPerformance_IRI="https://example.com/ids/sm/5312_6191_0132_6842"
qosPrediction_IRI="https://example.com/ids/sm/7465_1152_3042_5525"
...
for obj in new_object_store:
    if isinstance(obj, Submodel):
        if(obj.identification.id==nameplate_IRI):  #Nameplate Network
                    ...
                    for elemento_ref in elemento_contenido:
                        if elemento_ref.id_short=="ConnectedUE01": 
                            for elemento_ref2 in elemento_ref:
                                ...
                                if elemento_ref2.id_short=="Acceleration":acceleration=elemento_ref2
                            ...
                            connectedUE1=ConnectedUe(xPosition, yPosition, zPosition, speed, acceleration, lcsQosClass,accuracy, responseTime,elemento_ref.id_short,elemento_ref.value, elemento_ref.category, elemento_ref.description,elemento_ref.parent, elemento_ref.semantic_id, elemento_ref.qualifier, elemento_ref.kind)
                        ...
                        if elemento_ref.id_short=="ConnectedUE02": 
                            for elemento_ref2 in elemento_ref:
                                ...
                                if elemento_ref2.id_short=="Accuracy": accuracy=elemento_ref2
                                if elemento_ref2.id_short=="ResponseTime": responseTime=elemento_ref2
                            connectedUE2=ConnectedUe(xPosition, yPosition, zPosition, speed, acceleration, lcsQosClass,accuracy, responseTime, elemento_ref.id_short,elemento_ref.value, elemento_ref.category, elemento_ref.description,
                                                                                                    elemento_ref.parent, elemento_ref.semantic_id, elemento_ref.qualifier, elemento_ref.kind)
            ...
            networkLocation=Location(listOfConnectedUes,subscriptionRequest,listOfSubscriptions,obj.identification,obj.submodel_element,obj.id_short,obj.category,obj.description,obj.parent,obj.administration,obj.semantic_id,obj.qualifier,obj.kind)       
        elif(obj.identification.id==npn5GNWIdentity_IRI):  #NPN5GNWIdentity Network
            for elemento_contenido in obj:
        ...
        elif(obj.identification.id==assetServiceRegistry_IRI):  #AssetServiceRegistry Network
            for elemento_contenido in obj:
        ...
        elif(obj.identification.id==tsnCapabilities_IRI):  #TSNCapabilities Network
            for elemento_contenido in obj:
                if elemento_contenido.id_short=="Bridge5GSDelay":system5GBridgeDelay=elemento_contenido
                if elemento_contenido.id_short=="Bridge5GS": 
                    for elemento_ref in elemento_contenido:
                        if elemento_ref.id_short=="Bridge5GSConfiguration": 
                            for elemento_ref2 in elemento_ref:
                                if elemento_ref2.id_short=="BridgeID":bridgeID=elemento_ref2
                                if elemento_ref2.id_short=="Ports":ports=elemento_ref2
                                ...
                                if elemento_ref2.id_short=="TrafficClasses":trafficClasses=elemento_ref2
                        ...
                        if elemento_ref.id_short=="TsnFlowList": 
                            for elemento_ref2 in elemento_ref:
                                if elemento_ref2.id_short=="TsnFlowN":
                                    ...
                                    tsnFlow=TsnFlowN(destinationIP, destinationMacAddress, streamId, qosProfileAssociated, vlanID, maximumLatency, reliability, tscai, elemento_ref.id_short,elemento_ref.value, elemento_ref.category, elemento_ref.description,elemento_ref.parent, elemento_ref.semantic_id, elemento_ref.qualifier, elemento_ref.kind)
                    ...
                    bridge5GS=Bridge5GS(bridge5GSConfiguration, tsnFlowList, elemento_contenido.id_short,elemento_contenido.value, elemento_contenido.category, elemento_contenido.description, elemento_contenido.parent, elemento_contenido.semantic_id, elemento_contenido.qualifier, elemento_contenido.kind)
        ...
        elif(obj.identification.id==network5GDataSheet_IRI):  #Network5GDataSheet Network
            for elemento_contenido in obj:
                if elemento_contenido.id_short=="Release3GPP": release3GPP=elemento_contenido
                if elemento_contenido.id_short=="SupportedNetworkProtocols": supportedNetworkProtocols=elemento_contenido
                ...
                if elemento_contenido.id_short=="SpectrumBandUsed": spectrumBandUsed=elemento_contenido
                if elemento_contenido.id_short=="MaximumDLDataRate": maximumDLDataRate=elemento_contenido
                if elemento_contenido.id_short=="MaximumULDataRate": maximumULDataRate=elemento_contenido
                ...
                if elemento_contenido.id_short=="NetworkTopology": 
                    for elemento_ref in elemento_contenido.value:
                        ...
                        if elemento_ref.id_short=="Links": 
                            for elemento_ref2 in elemento_ref:
                            ...
                            links=Links(n1,n2,n3,n4,n5,n6,rx,naf,npcf,nsmf,namf,elemento_ref.id_short,elemento_ref.value, elemento_ref.category, elemento_ref.description,elemento_ref.parent, elemento_ref.semantic_id, elemento_ref.qualifier, elemento_ref.kind)
                    networkTopology=NetworkTopology(listOfRanNodes,listOfCN,links,elemento_contenido.id_short,elemento_contenido.value, elemento_contenido.category, elemento_contenido.description, elemento_contenido.parent, elemento_contenido.semantic_id, elemento_contenido.qualifier, elemento_contenido.kind)  
        ...
        elif(obj.identification.id==virtualsNetwork_IRI):  #VirtualsNetwork Network
            for elemento_contenido in obj:
                ...
                if elemento_contenido.id_short=="NetworkSliceReconfiguration": networkSliceReconfiguration=elemento_contenido
            virtualsNetwork=VirtualsNetwork(virtualLANList,networkSliceList,networkSliceReconfiguration, obj.identification,obj.submodel_element,obj.id_short,obj.category,obj.description,obj.parent,obj.administration,obj.semantic_id,obj.qualifier,obj.kind)              
        elif(obj.identification.id==connectivity_IRI):  #Connectivity Network
            for elemento_contenido in obj:
                if elemento_contenido.id_short=="UEsAttachedList": 
                    for elemento_ref in elemento_contenido.value:
                        if elemento_ref.id_short=="UEAttachedN": 
                            for elemento_ref2 in elemento_ref:
                                if elemento_ref2.id_short=="PEI":pei=elemento_ref2
                                if elemento_ref2.id_short=="GPSI": gpsi=elemento_ref2
                            ueAttachedN=UEAttachedN(pei,gpsi,elemento_ref.id_short,elemento_ref.value, elemento_ref.category, elemento_ref.description,elemento_ref.parent, elemento_ref.semantic_id, elemento_ref.qualifier, elemento_ref.kind)
                    ...
                    for elemento_ref in elemento_contenido.value:
                        if elemento_ref.id_short=="PDUSessionN":                                                                                
                            for elemento_ref2 in elemento_ref.value:
                                ...
                                if elemento_ref2.id_short=="DNDestination": dnDestination=elemento_ref2
                            ...
                            pduSessionConnectivity=PDUSessionConnectivity(ipAddress,ue,dnDestination,linkDirection,qosFlowConnectivityList,elemento_ref.id_short,elemento_ref.value, elemento_ref.category, elemento_ref.description,elemento_ref.parent, elemento_ref.semantic_id, elemento_ref.qualifier, elemento_ref.kind)
                ...
                if elemento_contenido.id_short=="QosMapping":qosMapping=elemento_contenido
                ...
                if elemento_contenido.id_short=="EstablishConnection":establishConnection=elemento_contenido
                if elemento_contenido.id_short=="ModifyConnection":modifyConnection=elemento_contenido
            connectivity=Connectivity(uesAttachedList,pduSessionConnectivityList, qosMapping, getRANConfiguration, setRANConfiguration,establishConnection, modifyConnection, obj.identification,obj.submodel_element,obj.id_short,obj.category,obj.description,obj.parent,obj.administration,obj.semantic_id,obj.qualifier,obj.kind)                       
        elif(obj.identification.id==qosPerformance_IRI):  #QosPerformance Network
            for elemento_contenido in obj:
                ...
                if elemento_contenido.id_short=="ListOfSubscriptions":
                        ...
                        listOfSubscriptions.add_subscription(subscription1)
                if elemento_contenido.id_short=="SubscriptionRequest":subscriptionRequest=elemento_contenido
                if elemento_contenido.id_short=="PerformanceOfAPacketTX":performanceOfAPacketTX=elemento_contenido
                if elemento_contenido.id_short=="PerformanceOfAQosFlow":performanceOfAQosFlow=elemento_contenido
                if elemento_contenido.id_short=="PerformanceOfAPDUSession":performanceOfAPDUSession=elemento_contenido
        ...
        elif(obj.identification.id==qosPrediction_IRI):  #QosPrediction Network
            for elemento_contenido in obj:
                if elemento_contenido.id_short=="ListOfSubscriptions":
                        for elemento_ref in elemento_contenido:
                            if elemento_ref.id_short=="ListOfEvents":
                                for elemento_ref2 in elemento_ref:  
                                    if elemento_ref2.id_short=="Event1":event1=elemento_ref2
                                listOfEvents= ListOfQosPredictionEvents(elemento_ref2.id_short,elemento_ref2.value, elemento_ref2.category, elemento_ref2.description,
                                                                                                        elemento_ref2.parent, elemento_ref2.semantic_id, elemento_ref2.qualifier, elemento_ref2.kind)
                                listOfEvents.add_event(event1)
                            if elemento_ref.id_short=="Subscription1":
                                subscription1=elemento_ref
                        
                        listOfSubscriptions= ListOfQosPredictionSubscriptions(listOfEvents,elemento_ref2.id_short,elemento_ref2.value, elemento_ref2.category, elemento_ref2.description,
                                                                                            elemento_ref2.parent, elemento_ref2.semantic_id, elemento_ref2.qualifier, elemento_ref2.kind)
                        listOfSubscriptions.add_subscription(subscription1)
            qosPrediction=QosPrediction(listOfSubscriptions, obj.identification,obj.submodel_element,obj.id_short,obj.category,obj.description,obj.parent,obj.administration,obj.semantic_id,obj.qualifier,obj.kind) 
